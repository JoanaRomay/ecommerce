      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Box sx={{ minWidth: 150}  }>
            ...
            <Typography sx={{pb:2}  }>
            En TK-PetShop mimamos a tu mascota como se merece. <br />Juguetes, alimentos y mucho amor para que tu perro <br /> o gato disfrute cada momento al máximo.
            </Typography>     
        ...
        >
          <Typography variant="body2" sx={{ opacity: 0.7 }}>
            © 2025 Tk PetShop. Todos los derechos reservados.
          </Typography>
        </Stack>
      </Container>
    </Box>
